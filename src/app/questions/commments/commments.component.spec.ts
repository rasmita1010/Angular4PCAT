...
describe('Comments Component', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            imports: [HttpModule, FormsModule, LoadersCssModule, DataTableModule, RouterTestingModule],
            declarations: [CommmentsComponent, MockModal, HighlightPipe, FormatDateMonthPipe, FormatDateTimePipe],
            providers: [
        ...
        }).overrideComponent(CommmentsComponent, {
            set: {
                providers: [
                    { provide: Router, useClass: MockRouterNoLogin },
                    { provide: LocalStorageService, useClass: MockLocalStorage },
        ...
        const fixture = TestBed.createComponent(CommmentsComponent);
