...
import { FormatDateMonthPipe, FormatDateTimePipe, MagazineDemoOfferCode } from '../../_pipes/custom.pipes';
...
describe('Magazine Component', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            declarations: [MagazineComponent, MockModal, FormatDateMonthPipe, FormatDateTimePipe, MagazineDemoOfferCode],
            providers: [
        ...
        }).overrideComponent(MagazineComponent, {
            set: {
                providers: [
                    { provide: Router, useClass: MockRouterNoLogin },
                    { provide: LocalStorageService, useClass: MockLocalStorage },
        ...
        const fixture = TestBed.createComponent(MagazineComponent);
