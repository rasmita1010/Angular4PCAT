...
import { FormatDateMonthPipe, FormatDateTimePipe, DemoOfferSearchPipe } from '../../_pipes/custom.pipes';
...
describe('User-View Component', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            declarations: [UsersViewComponent, MockModal, FormatDateMonthPipe, FormatDateTimePipe, DemoOfferSearchPipe],
            providers: [
        ...
        const fixture = TestBed.createComponent(UsersViewComponent);
    ...
    it('Should Load Component Successfully', inject([Router, QuestionService, SharedService, ActivatedRoute], (router: Router, questionSvc: QuestionService, sharedSvc: SharedService, _route: ActivatedRoute) => {
        component.UserViewHasErrors = true;
        fixture.detectChanges();
